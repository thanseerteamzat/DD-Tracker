...
@Component({
  selector: 'app-ddentry-details',
  templateUrl: './ddentry-details.component.html',
  styleUrls: ['./ddentry-details.component.css']
})
export class DdentryDetailsComponent implements OnInit {
