...
import { adjdespatchList, adjDespatch, adjtaxtemp } from '../models/adjlastid';
import { Common } from '../models/common';
import { adjddEntry, adjddList } from '../models/adjlastid';
import { element } from 'protractor';

@Component({
  selector: 'app-adj-despstudlist',
  templateUrl: './adj-despstudlist.component.html',
  styleUrls: ['./adj-despstudlist.component.css']
})
export class AdjDespstudlistComponent implements OnInit {
  ...
  selectedDespatch;
  ddLists: adjddList[] = [];
  ddentrylist: adjddEntry[] = [];
  selectedData: Array<adjddList>;
  temp: adjddEntry;
  total; totalTemp;
  tax; taxTotal;
  feeWtax; feeWTtemp;
  ...
  constructor(
    ...
    itemRef.snapshotChanges().subscribe(action => {
      ...
      quotationobj.forEach(element => {
        ...
        let ddentryitem = new adjddEntry();
