...
@Component({
  selector: 'app-adjpendingdd',
  templateUrl: './adjpendingdd.component.html',
  styleUrls: ['./adjpendingdd.component.css']
})
export class AdjpendingddComponent implements OnInit {
